 ...
 */
export default class OseDataModelCharacterEncumbranceBasic extends OseDataModelCharacterEncumbrance implements CharacterEncumbrance {
   ...
   * A map of strings to numbers indicating how heavy a set of armor is.
	...
	constructor(
		...
		items: Item[] = [],
		options: Options = {
			significantTreasure: OseDataModelCharacterEncumbranceBasic.significantTreasure
		}
	) {
