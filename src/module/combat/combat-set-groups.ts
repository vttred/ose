...
export default class OSECombatGroupSelector extends HandlebarsApplicationMixin(
  ApplicationV2
) {
  _highlighted;
  ...
  static PARTS = {
    main: {
      template: `/systems/${game.system.id}/dist/templates/apps/combat-set-groups.hbs`,
    },
  };
